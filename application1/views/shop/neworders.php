          ...
          <div class="box-body">
            ...
            <div class="row">
              ...
              <div class="col-xs-12">
                ...
                <h3 class="box-title" style="padding-bottom: 0px;"><i class="fa fa-question-circle"></i> All Orders</h3>
                ...
                <!--      <a href="<?= base_url('adminnew/neworderss') ?>">-->
                ...
                <!--    <a href="<?= base_url('adminnew/cancelorderss') ?>">-->
                          ...
                          <?php foreach($orders as $ordersarray){ ?>
                              ...
                              <div class="row cont">
                                 ...
                                 <div class="col-md-12 ">
                                    ...
                                    <h4 style="font-weight: 600"><a href="<?php echo base_url().'shop/invoice?invoice='.base64_encode($ordersarray['id']); ?>"> <?php echo $ordersarray['invoice_no'];?>

                                      <div class="deliverydate" style="float: right;"></a>

                                        <div class="_30ud5x _3ELbo9"></div>

                                        <span class="ptitle"><?php echo (isset($ordersarray['payment_status']) && !empty($ordersarray['payment_status']) ? $ordersarray['payment_status'] : ''); ?></span>
