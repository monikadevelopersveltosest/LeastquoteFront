        ...
        <div class="box">
          <div class="box-body">
            <div class="table-responsive">
              <h3 class="box-title" style="padding-bottom: 10px;">All Promotion List</h3>
                <div class="row">
                    <form >
                            ...
                            foreach ($promotionlist as $key => $value) {
                                ?>
                                    <tr>
                                        ...
                                        <td><a ><?php echo $value['description']; ?></a></td>
                                        <td><?php  echo (!empty($value['image'])?'<img src='.base_url().'uploads/promotion/'.$value['image'].' style="width:50px;height:50px">':'none'); ?></td>
                                        <td><?php echo $value['created_date']; ?></td>
                                        <td>
                                          <a href="<?php echo base_url().'shop/addPromotion/'.$value['id']?>" title="Edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> 
                                          &nbsp;
  ...
  $(".delete").click(function(e){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'promotion',id:id,colwhr:'id',action:"Delete"},
        dataType:'json',
        success: function(response) {
          if (response.status == 1){
            $.notify(response.msg, "success");
