      ...
      <div class="row no-print">
        ...
        <div class="col-xs-12">
          ...
          <?php if($orderdata['delivery_status'] == 2){ ?>
            ...
            <a href="javascript:void(0)" href-id="<?php echo $orderdata['id']?>" class="btn btn-success received_order" href-status="0" > <span>Accept Order </span> </a>
  ...
  $(".received_order").click(function(e){
        ...
        if(val){
          ...
          $.ajax({
            ...
            data:{tablename:'orders',id:id,status:3,whrcol:'id',whrstatuscol:'delivery_status',action:"Accept"},
