 ...
 <style>
  ...
  <div class="hero-section">
        ...
        <div class="container">
            <div class="about-wrapper mt--100 mt-lg--440 padding-top">
                <div class="row">
                    <div class="col-lg-7 col-xl-6">
                        <div class="about-content">
                            ...
                            <h2 class="title"><span class="d-block">OVER 6</span> YEARS EXPERIENCE</h2>
                            <p>Innovation have made us leaders in Quotation platform</p>
                            <div class="item-area">
                                <div class="item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/about/01.png" alt="about">
                                    </div>
                                    <p>award-winning team</p>
                                </div>
                                <div class="item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/about/02.png" alt="about">
                                    </div>
                                    <p>AFFILIATIONS</p>
                                </div>
                            </div>
                ...
                <div class="about-thumb">
                    <img src="<?php echo base_url();?>fornt_new_assests/assets/images/about/banner-1.png" alt="about">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container mw-lg-100 p-lg-0">
            <div class="row m-0">
                        ...
                        <div class="row mb--50">
                            <div class="col-sm-6">
                                <div class="expert-item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/overview/01.png" alt="overview">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6">
                                <div class="expert-item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/overview/02.png" alt="overview">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6">
                                <div class="expert-item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/overview/03.png" alt="overview">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6">
                                <div class="expert-item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/overview/04.png" alt="overview">
                                    </div>
                                    <div class="content">
                                        <h6 class="title">Supports Multiple Currency</h6>
                                    </div>
                            ...
                            <div class="col-sm-6">
                                <div class="expert-item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/overview/05.png" alt="overview">
                                    </div>
                                    <div class="content">
                            ...
                            <div class="col-sm-6">
                                <div class="expert-item">
                                    <div class="thumb">
                                        <img src="<?php echo base_url();?>fornt_new_assests/assets/images/overview/06.png" alt="overview">
                                    </div>
                                    <div class="content">
                ...
                <div class="col-lg-6 pl-30 pr-0">
                    <div class="w-100 h-100 bg_img" data-background="<?php echo base_url();?>fornt_new_assests/assets/images/overview/overview-bg.png"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="call-in-section padding-top padding-bottom">
        <div class="container">
            <div class="call-wrapper cl-white bg_img" data-background="<?php echo base_url();?>fornt_new_assests/assets/images/call-in/call-bg.png">
                <div class="section-header">
                    <h3 class="title">Register for Free & Start Quote Now!</h3>
            ...
            <div class="team-wrapper row justify-content-between">
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="<?php echo base_url();?>fornt_new_assests/assets/images/team/team1.png" alt="team">
                            </a>
                        </div>
                ...
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="<?php echo base_url();?>fornt_new_assests/assets/images/team/team2.png" alt="team">
                            </a>
                        </div>
                        <div class="team-content">
                ...
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="<?php echo base_url();?>fornt_new_assests/assets/images/team/team3.png" alt="team">
                            </a>
                        </div>
                        <div class="team-content">
                ...
                <div class="team-item">
                    <div class="team-inner">
                        <div class="team-thumb">
                            <a href="#0">
                                <img src="<?php echo base_url();?>fornt_new_assests/assets/images/team/team4.png" alt="team">
                            </a>
                        </div>
                        <div class="team-content">
