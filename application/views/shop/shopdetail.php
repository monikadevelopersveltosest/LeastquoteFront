        ...
        <div class="col-md-3">
            ...
            <div class="box-body box-profile">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item ">
                  <b>Shop Id </b>  :  <a class="pull-right ml2" style="margin-left:10px;"><?php echo (isset($shop_data['shop_reg_id']) ? $shop_data['shop_reg_id'] : '')?></a>
                </li>
                <!-- <li class="list-group-item">
               ...
               <!--  <li class="list-group-item">
                ...
                <li class="list-group-item">
                  <b>Tax identification number</b>   <a class="pull-right ml2" style="margin-left:10px;"> <?php echo (!empty($shop_data) && !empty($shop_data['pan_no']) ? base64_decode($shop_data['pan_no']) : "" );?></a>
                </li>
                <li class="list-group-item">
                  <b>Years in business</b>  <a class="pull-right ml2" style="margin-left:10px;"><?php echo (isset($shop_data['year_business']) ? $shop_data['year_business'] : '')?></a>
                </li>
                <li class="list-group-item">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              ...
              <p class="text-muted">
                <i class="fa fa-envelope margin-r-5"></i><a class="pull-right"><?php echo (isset($shop_data['email']) ? $shop_data['email'] : '')?></a>
              </p>

              <p class="text-muted">
                <i class="fa fa-phone margin-r-5"></i><a class="pull-right"><?php echo (isset($shop_data['mobile_no']) && isset($shop_data['country_code']) ? $shop_data['country_code'].$shop_data['mobile_no'] : '')?></a>
              </p>
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <!-- <li><a href="#personaldetail" data-toggle="tab">Personal Detail</a></li> -->
              <li><a href="#businessdetail" data-toggle="tab">Business Detail</a></li>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="pandetail">
                <div class="row">
                  <div class="col-md-6">
                    <p><b>Tax identification number </b> :  <span><?php echo base64_decode($shop_data['pan_no']); ?></span></p>
              ...
              <div class="active tab-pane" id="personaldetail">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Email-Id </b> <a class="pull-right"><?php echo (isset($shop_data['email']) ? $shop_data['email'] : '')?></a>
                        </li>
                    </ul>
                  </div>
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>PAN Number </b> <a class="pull-right"><?php echo (isset($shop_data['pan_no']) ? $shop_data['pan_no'] : '')?></a>
                        </li>
                    </ul>
                  </div>
                  <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Adhar Number </b> <a class="pull-right"><?php echo (isset($shop_data['adhar_no']) ? $shop_data['adhar_no'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <div class="col-md-6">
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-md-6">
                  ...
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>PIN Code</b> <a class="pull-right"><?php echo (isset($shop_data['pincode']) ? $shop_data['pincode'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>City</b> <a class="pull-right"><?php echo (isset($shop_data['bank_city_name']) ? $shop_data['bank_city_name'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <div class="col-md-6">
              ...
              <div class="tab-pane" id="businessdetail">
                ...
                <div class="row">
                  ...
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b> Shop Type </b> <a class="pull-right"><?php echo (isset($shop_data['shop_type_name']) ? $shop_data['shop_type_name'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <!-- <div class="col-md-6">
                  ...
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Address </b> <a class="pull-right"><?php echo (isset($shop_data['shop_address']) ? $shop_data['shop_address'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Landmark</b> <a class="pull-right"><?php echo (isset($shop_data['shop_landmark']) ? $shop_data['shop_landmark'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>PIN Code</b> <a class="pull-right"><?php echo (isset($shop_data['shop_pincode']) ? $shop_data['shop_pincode'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>City</b> <a class="pull-right"><?php echo (isset($shop_data['city_name']) ? $shop_data['city_name'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  <div class="col-md-6">
                  ...
                  <!-- <div class="col-md-6">
                    <ul class="list-group list-group-unbordered">
                        <li class="list-group-item">
                          <b>Address Id Proof Type </b> <a class="pull-right"><?php echo (isset($shop_data['id_proof_type']) ? $shop_data['id_proof_type'] : '')?></a>
                        </li>
                    </ul>
                  </div> -->
                  
                  <!-- <div class="col-md-6">
                    <p><b>Address Id Proof </b> :  <span><?php echo base64_decode($shop_data['id_proof_id']); ?></span></p>
                      <?php if(!empty($shop_data['pan_image'])){ ?>
                        <div class="form-group">
                          <img src="<?php echo base_url()?>uploads/shop_images/<?php echo $shop_data['id_proof_image'];?>" class="img-responsive">
                        </div>
                      <?php } ?>
                  </div> -->
                  ...
                  <!-- <div class="col-md-6">
                    <p><b>GST Image </b></p>
                      <?php if(!empty($shop_data['gst_image'])){ ?>
                        <div class="form-group">
                      
                          <img src="<?php echo base_url()?>uploads/shop_images/gst_image/<?php echo $shop_data['gst_image'];?>" class="img-responsive" style="height: 150px; width: 200px">
                        </div>
                      <?php } ?>
                  </div> -->
                  <!-- <div class="col-md-6">
                    <p><b>Shop Image for Desktop</b></p>
                      <?php if(!empty($shop_data['shop_image_desktop'])){ ?>
                        <div class="form-group">
                          <img src="<?php echo base_url()?>uploads/shop_images/shop_image_desktop/<?php echo $shop_data['shop_image_desktop'];?>" class="img-responsive" style="height: 150px; width: 200px">
                        </div>
                      <?php } ?>
                  </div> -->
                  <div class="col-md-6">
                    <p><b>Shop Image</b></p>
                      <?php if(!empty($shop_data['shop_image_mobile'])){ ?>
                        <div class="form-group">
                          <img src="<?php echo base_url()?>uploads/shop_images/shop_image_mobile/<?php echo $shop_data['shop_image_mobile'];?>" class="img-responsive" style="height: 150px; width: 200px">
                        </div>
                      <?php } ?>
                  </div>
                  <div class="col-md-6">
                    <p><b>Owner Image </b></p>
                      <?php if(!empty($shop_data['owner_image'])){ ?>
                        <div class="form-group">
                          <img src="<?php echo base_url()?>uploads/shop_images/shop_owner_images/<?php echo $shop_data['owner_image'];?>" class="img-responsive" style="height: 150px; width: 200px">
                        </div>
                      <?php } ?>
                  </div>
                </div>
