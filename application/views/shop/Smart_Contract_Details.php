...
<script src="https://cdn.ckeditor.com/4.16.0/standard/ckeditor.js"></script>
  ...
  <div class="content-wrapper">
   ...
   <?php if($seller_data) { 
      ...
      <h1>Edite Smart Contract Details</h1>
      ...
      <h1>Add Smart Contract Details</h1>
          ...
          <form role="form" enctype="multipart/form-data" method="post" action="">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control"  value="<?php echo (isset($seller_data['title']) ?  $seller_data['title'] : '');?>" name="title"  disabled="disabled"/>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea rows="10" cols="180" name="editor1" value="<?php echo (isset($seller_data['editor1']) ?  $seller_data['editor1'] : '');?>" disabled="disabled" ><?php echo (isset(
