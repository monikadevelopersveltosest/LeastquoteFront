  ...
  <div class="login-box-body">
    ...
    <form  id="loginform" method="post" style="padding: 15px;">
      <div class="form-group has-feedback">
        ...
        <select name="country_code" id="country_code" class="form-control" style="width: 31%;height: 31px;display: inline-block; border:1px #F90 solid; border-radius: .25rem; background-color:#fdfac6;">
          <option>+1</option>
          <option>+91</option>
        </select>
        <input type="tel" pattern="[0-9]{3}[0-9]{3}[0-9]{4}" id="mobile_no" placeholder="Mobile No." value="" style="width: 99%;display: inline-block;">
