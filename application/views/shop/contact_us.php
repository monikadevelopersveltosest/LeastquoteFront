      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header col-md-6" style="float: left;">
            <h3 class="box-title">
                <a href="<?php echo base_url();?>shop/contact_to_admin" class="btn btn-primary pull-right">Contact To Admin</a>
            </h3>
          </div>
          ...
          <div class="box-body table-responsive">
            <table id="categorytable" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php $count = 1; 
                  if(!empty($contact_vendor)){
                    foreach ($contact_vendor as $getdata) { 
                  ?>
                    <tr>
...
<script type="text/javascript">
    ...
    $('.btn_delete').click(function(){
        ...
        if(val!=""){
            ...
            data:{id:id,table:'contact_vendor',colwhr:'id'},
            dataType: 'json',
