      ...
      <div class="row">
        <div class="box box-primary">
          ...
          <?php if(isset($success) && !empty($success)){ 
               ...
               echo '<meta http-equiv="refresh" content="2;url='.base_url('shop/coupons').'">';
            } 
          ...
          <div class="col-md-12">
            ...
            <form action="" method="post">
              <div class="row">
                ...
                <div class="col-sm-4">
                  <fieldset class="form-group">
                  <label for="">Offer Amount<span style="color:#FF0000;">*</span> (In %)</label>
                  ...
                  <input type="hidden" name="offer_amount_type" value="1">
                </div>
                <!-- <div class="col-sm-4">
              ...
              <div class="row">
                <div class="col-sm-12" align="center">
                  <?php if(isset($coupons_data['id']) && !empty($coupons_data['id'])){ ?>
                      <input type="hidden" name="id" value="<?php echo $coupons_data['id']; ?>">
